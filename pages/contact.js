											...
											<li className="location_item">
												<div className="item">
													...
													<div className="content_holder">
														<ul>
															<li>404 room, esplanade mall Rasulgarh</li>
															<li>Phone: 7008578181</li>
															<li>Email: <Link href="support@kristellar.com"><a>support@kristellar.com</a></Link></li>
														</ul>
													</div>
												</div>
											</li>
											...
											<li className="location_item">
												<div className="item">
													...
													<div className="content_holder">
														<ul>
															<li>Phone: 7008578181</li>
															<li>Email: <Link href="support@kristellar.com"><a>support@kristellar.com</a></Link></li>								</ul>
													</div>
												</div>
											</li>
