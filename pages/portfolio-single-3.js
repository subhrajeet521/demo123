...
export default function Portfolio3() {
	return (
		<>
		<Title title='Portfolio Single 3' />
			<Layout>
								...
								<div className="helpful_part">
									...
									<div className="hp_inner">
										<ul>
											...
											<li>
												<p>Total length</p>
												<span>575 m (1,886 ft)</span>
											</li>
											<li>
												<p>Material</p>
												<span>Concrete and Steel</span>
											</li>
											<li>
												<p>Height</p>
												<span>77 m (253 ft)</span>
											</li>
											<li>
												<p>Construction Start</p>
												<span>2009</span>
											</li>
											<li>
												<p>Construction End</p>
												<span>2012</span>
											</li>
											<li>
												<p>Opened</p>
