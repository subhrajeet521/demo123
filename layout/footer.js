                            ...
                            <div className="inner">
                                <ul className="widget_area">
                                    <li>
                                        <div className="item">
                                            <div className="logo">
                                                <Link href="/"><a><img src="img/main-logo.png" alt="" /></a></Link>
                                            </div>
                    ...
                    <div className="container">
                        <div className="footer_bottom_in">
                            ...
                            <div className="footer_copyright">
                                <p>&copy; Kristellar Aerospace, LCC. All rights reserved. <Link href="https://themeforest.net/user/trendycoder"><a target="_blank" rel="noreferrer"></a></Link></p>
                            </div>
                            <Link href="#">
